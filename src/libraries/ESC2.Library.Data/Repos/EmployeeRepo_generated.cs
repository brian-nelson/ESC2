...
{
    public partial class EmployeeRepo : AbstractGuidRepo<ESC2.Library.Data.DataObjects.Employee>
    {
        ...
        public override ESC2.Library.Data.DataObjects.Employee ToObject(DataRow row)
        {
            var obj = new ESC2.Library.Data.DataObjects.Employee();
        ...
        public override List<DbQueryParameter> ToParameters(ESC2.Library.Data.DataObjects.Employee obj)
         {
