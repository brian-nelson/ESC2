...
{
    public partial class VersionRepo : AbstractGuidRepo<ESC2.Library.Data.DataObjects.Version>
    {
        ...
        public override string UpdateSql => @"
            UPDATE [dbo].[version] 
            SET [dbo].[version].[stig_id]=@StigId,
                [dbo].[version].[number]=@Number,
        ...
        public override ESC2.Library.Data.DataObjects.Version ToObject(DataRow row)
        {
            var obj = new ESC2.Library.Data.DataObjects.Version();
        ...
        public override List<DbQueryParameter> ToParameters(ESC2.Library.Data.DataObjects.Version obj)
         {
