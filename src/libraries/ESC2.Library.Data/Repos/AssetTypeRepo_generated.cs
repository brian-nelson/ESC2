...
{
    public partial class AssetTypeRepo : AbstractGuidRepo<ESC2.Library.Data.DataObjects.AssetType>
    {
        ...
        public override string SelectSql => @"
            SELECT [dbo].[asset_type].[asset_type_id],
                   ...
                   [dbo].[asset_type].[manufacturer],
                   [dbo].[asset_type].[model],
                   [dbo].[asset_type].[stig_id],
                   [dbo].[asset_type].[asset_group_id]
            FROM [dbo].[asset_type] ";

        public override ESC2.Library.Data.DataObjects.AssetType ToObject(DataRow row)
        {
            var obj = new ESC2.Library.Data.DataObjects.AssetType();
            ...
            obj.StigId = row.GetNullableGuid("stig_id");
            obj.AssetGroupId = row.GetGuid("asset_group_id");
            return obj;
        }


        public override List<DbQueryParameter> ToParameters(ESC2.Library.Data.DataObjects.AssetType obj)
         {
