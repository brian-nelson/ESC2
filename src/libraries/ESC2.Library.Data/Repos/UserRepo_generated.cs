...
{
    public partial class UserRepo : AbstractGuidRepo<ESC2.Library.Data.DataObjects.User>
    {
        ...
        public override ESC2.Library.Data.DataObjects.User ToObject(DataRow row)
        {
            var obj = new ESC2.Library.Data.DataObjects.User();
        ...
        public override List<DbQueryParameter> ToParameters(ESC2.Library.Data.DataObjects.User obj)
         {
