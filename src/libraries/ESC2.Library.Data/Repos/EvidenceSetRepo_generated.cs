...
{
    public partial class EvidenceSetRepo : AbstractGuidRepo<ESC2.Library.Data.DataObjects.EvidenceSet>
    {
        ...
        public override ESC2.Library.Data.DataObjects.EvidenceSet ToObject(DataRow row)
        {
            var obj = new ESC2.Library.Data.DataObjects.EvidenceSet();
        ...
        public override List<DbQueryParameter> ToParameters(ESC2.Library.Data.DataObjects.EvidenceSet obj)
         {
