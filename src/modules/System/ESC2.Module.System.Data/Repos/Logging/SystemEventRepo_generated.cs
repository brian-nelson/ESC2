...
{
    public partial class SystemEventRepo : AbstractDataRepo<ESC2.Module.System.Data.DataObjects.Logging.SystemEvent, Int64>
    {
        ...
        public override string InsertSql => @"
            INSERT INTO [logging].[system_event] (
                [logging].[system_event].[customer_id],
                [logging].[system_event].[received_at],
                [logging].[system_event].[device_reported_time],
                [logging].[system_event].[facility],
                [logging].[system_event].[priority],
                [logging].[system_event].[from_host],
                [logging].[system_event].[message],
                [logging].[system_event].[nt_severity],
                [logging].[system_event].[importance],
                [logging].[system_event].[event_source],
                [logging].[system_event].[event_user],
                [logging].[system_event].[event_category],
                [logging].[system_event].[event_id],
                [logging].[system_event].[event_binary_data],
                [logging].[system_event].[maximum_available],
                [logging].[system_event].[current_usage],
                [logging].[system_event].[minimum_usage],
                [logging].[system_event].[maximum_usage],
                [logging].[system_event].[info_unit_id],
                [logging].[system_event].[sys_log_tag],
                [logging].[system_event].[event_log_type],
                [logging].[system_event].[generic_file_name],
                [logging].[system_event].[system_id])
            VALUES ( 
                @CustomerId,
                @ReceivedAt,
                @DeviceReportedTime,
        ...
        public override string UpdateSql => @"
            UPDATE [logging].[system_event] 
            SET [logging].[system_event].[customer_id]=@CustomerId,
                [logging].[system_event].[received_at]=@ReceivedAt,
                [logging].[system_event].[device_reported_time]=@DeviceReportedTime,
                [logging].[system_event].[facility]=@Facility,
                [logging].[system_event].[priority]=@Priority,
                [logging].[system_event].[from_host]=@FromHost,
                [logging].[system_event].[message]=@Message,
                [logging].[system_event].[nt_severity]=@NtSeverity,
                [logging].[system_event].[importance]=@Importance,
                [logging].[system_event].[event_source]=@EventSource,
                [logging].[system_event].[event_user]=@EventUser,
                [logging].[system_event].[event_category]=@EventCategory,
                [logging].[system_event].[event_id]=@EventId,
                [logging].[system_event].[event_binary_data]=@EventBinaryData,
                [logging].[system_event].[maximum_available]=@MaximumAvailable,
                [logging].[system_event].[current_usage]=@CurrentUsage,
                [logging].[system_event].[minimum_usage]=@MinimumUsage,
                [logging].[system_event].[maximum_usage]=@MaximumUsage,
                [logging].[system_event].[info_unit_id]=@InfoUnitId,
                [logging].[system_event].[sys_log_tag]=@SysLogTag,
                [logging].[system_event].[event_log_type]=@EventLogType,
                [logging].[system_event].[generic_file_name]=@GenericFileName,
                [logging].[system_event].[system_id]=@SystemId
            WHERE [logging].[system_event].[system_event_id]=@Id ";

        public override string SelectSql => @"
            SELECT [logging].[system_event].[system_event_id],
                   [logging].[system_event].[customer_id],
                   [logging].[system_event].[received_at],
                   [logging].[system_event].[device_reported_time],
                   [logging].[system_event].[facility],
                   ...
                   [logging].[system_event].[generic_file_name],
                   [logging].[system_event].[system_id]
            FROM [logging].[system_event] ";

        public override string DeleteSql => @"DELETE FROM [logging].[system_event] WHERE [logging].[system_event].[system_event_id] = @Id";

        public override string GetByIdSql => $@"{SelectSql} WHERE [logging].[system_event].[system_event_id = @Id";
        public override ESC2.Module.System.Data.DataObjects.Logging.SystemEvent ToObject(DataRow row)
        {
            var obj = new ESC2.Module.System.Data.DataObjects.Logging.SystemEvent();
        ...
        public override List<DbQueryParameter> ToParameters(ESC2.Module.System.Data.DataObjects.Logging.SystemEvent obj)
        {
