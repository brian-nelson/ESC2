...
{
    public partial class SystemEventFactRepo : AbstractIdentityRepo<ESC2.Module.System.Data.DataObjects.SystemEventFact, Int64>
    {
        ...
        public override ESC2.Module.System.Data.DataObjects.SystemEventFact ToObject(DataRow row)
        {
            ...
            obj.Id = row.GetLong("system_event_fact_id");
            obj.AssetId = row.GetGuid("asset_id");
            obj.PeriodId = row.GetLong("period_id");
            obj.SystemEventSeverityId = row.GetByte("system_event_severity_id");
            obj.SystemEventFacilityId = row.GetByte("system_event_facility_id");
        ...
        public override List<DbQueryParameter> ToParameters(ESC2.Module.System.Data.DataObjects.SystemEventFact obj)
        {
            ...
            parameters.Add(new DbQueryParameter("SystemEventSeverityId", obj.SystemEventSeverityId, DbQueryParameterType.Byte));
            parameters.Add(new DbQueryParameter("SystemEventFacilityId", obj.SystemEventFacilityId, DbQueryParameterType.Byte));
